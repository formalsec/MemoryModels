...
let () =
  ...
  in
  let obj1, pc =
    get_obj (Obj.set obj1 ~field:(key_c "b") ~data:(value_int 200) pc)
  in
  let obj2, pc =
    get_obj (Obj.set obj2 ~field:(key_c "c") ~data:(value_int 300) pc)
  in
  let obj2, pc =
    get_obj (Obj.set obj2 ~field:(key_c "d") ~data:(value_int 400) pc)
  in
  let obj3, pc =
    get_obj (Obj.set obj3 ~field:(key_c "e") ~data:(value_int 500) pc)
  in
  let obj3, pc =
    get_obj (Obj.set obj3 ~field:(key_c "f") ~data:(value_int 600) pc)
  in
  let obj4, pc =
    get_obj (Obj.set obj4 ~field:(key_c "g") ~data:(value_int 700) pc)
  in
  let obj4, pc =
    get_obj (Obj.set obj4 ~field:(key_c "h") ~data:(value_int 800) pc)
  in
  let obj5, pc =
    get_obj (Obj.set obj5 ~field:(key_c "i") ~data:(value_int 900) pc)
  in
  let obj5, pc =
  ...
  assert (
    Mem.has_field m loc1 (key_c "b") pc = Obj.has_field obj1 (key_c "b") pc );
  assert (
    Mem.has_field m loc2 (key_c "c") pc = Obj.has_field obj2 (key_c "c") pc );
  assert (
    Mem.has_field m loc2 (key_c "d") pc = Obj.has_field obj2 (key_c "d") pc );
  assert (
    Mem.has_field m loc3 (key_c "e") pc = Obj.has_field obj3 (key_c "e") pc );
  assert (
    Mem.has_field m loc3 (key_c "f") pc = Obj.has_field obj3 (key_c "f") pc );
  assert (
    Mem.has_field m loc4 (key_c "g") pc = Obj.has_field obj4 (key_c "g") pc );
  assert (
    Mem.has_field m loc4 (key_c "h") pc = Obj.has_field obj4 (key_c "h") pc );
  assert (
    Mem.has_field m loc5 (key_c "i") pc = Obj.has_field obj5 (key_c "i") pc );
  assert (
    Mem.has_field m loc5 (key_c "j") pc = Obj.has_field obj5 (key_c "j") pc );

  (* has_fields on unknown fields and fields that does not exist in that object *)
  assert (
    Mem.has_field m loc1 (key_c "100") pc = Obj.has_field obj1 (key_c "100") pc );
  assert (
    Mem.has_field m loc1 (key_c "200") pc = Obj.has_field obj1 (key_c "200") pc );
  assert (
    Mem.has_field m loc2 (key_c "a") pc = Obj.has_field obj2 (key_c "a") pc );
  assert (
    Mem.has_field m loc2 (key_c "b") pc = Obj.has_field obj2 (key_c "b") pc );
  assert (
    Mem.has_field m loc3 (key_c "500") pc = Obj.has_field obj3 (key_c "500") pc );
  assert (
    Mem.has_field m loc3 (key_c "c") pc = Obj.has_field obj3 (key_c "c") pc );
  assert (
    Mem.has_field m loc4 (key_c "700") pc = Obj.has_field obj4 (key_c "700") pc );
  assert (
    Mem.has_field m loc4 (key_c "d") pc = Obj.has_field obj4 (key_c "d") pc );
  assert (
    Mem.has_field m loc5 (key_c "900") pc = Obj.has_field obj5 (key_c "900") pc );
  assert (
    Mem.has_field m loc5 (key_c "1000") pc
    = Obj.has_field obj5 (key_c "1000") pc );
